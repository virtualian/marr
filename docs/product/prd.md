...
- **Project-level** (`./MARR-PROJECT-CLAUDE.md` + `./.marr/`) - Project-specific requirements and standards
...
4. System creates `./MARR-PROJECT-CLAUDE.md` and `./.marr/` with project standards
...
- Project-level standards in `./MARR-PROJECT-CLAUDE.md` and `./.marr/` (project-specific)
...
└─────────────────────────────────────────┘
                 ↓ inherits
┌─────────────────────────────────────────┐
│  Project Level (./MARR-PROJECT-CLAUDE.md, ./.marr/)  │
