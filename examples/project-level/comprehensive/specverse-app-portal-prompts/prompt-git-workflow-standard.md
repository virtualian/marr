# SpecVerse Git Workflow Standard

> **AI Agent Instructions**: This document defines how SpecVerse develops, reviews, releases, and deploys software using Git and GitHub. Follow these rules exactly for all code changes, regardless of size or complexity.
>
...
SpecVerse uses GitHub issue types for work categorization:
...
- SpecVerse's 5-day limit is conservative but practical for team coordination
...
SpecVerse uses automated release scripts that handle version bumping, tagging, and deployment to Vercel.
...
6. Deploys to Vercel production automatically
...
**MANDATORY INTEGRATION**: These git workflow standards work in conjunction with SpecVerse Testing Standards. Both must be followed simultaneously - no exceptions.
...
When working on SpecVerse projects:
...
11. **Create draft PRs immediately** for CI feedback
12. **Follow squash merge strategy** always
13. **Delete branches after merge** - follow industry standard
14. **Use npm release scripts** - `npm run release:patch/minor/major` for releases
...
**MANDATORY**: All AI agents working on this project must follow these Git Workflow standards. No exceptions for any code changes, regardless of urgency, size, or perceived complexity.
